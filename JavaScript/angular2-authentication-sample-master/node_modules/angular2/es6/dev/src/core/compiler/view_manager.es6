...
export class AppViewManager {
  ...
  createDynamicComponentView(hostLocation, componentProtoView, componentBinding, injector) {
  ...
  createInPlaceHostView(parentComponentLocation, hostElementSelector, hostProtoView, injector) {
  ...
  destroyInPlaceHostView(parentComponentLocation, hostView) {
  ...
  createViewInContainer(viewContainerLocation, atIndex, protoView, injector = null) {
  ...
  attachViewInContainer(viewContainerLocation, atIndex, view) {
