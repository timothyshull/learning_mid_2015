...
var $__3 = ($__directive_95_record__ = require("./directive_record"), $__directive_95_record__ && $__directive_95_record__.__esModule && $__directive_95_record__ || {default: $__directive_95_record__}),
    DirectiveIndex = $__3.DirectiveIndex,
    DirectiveRecord = $__3.DirectiveRecord;
...
Object.defineProperty(BindingRecord, "parameters", {get: function() {
    return [[$traceurRuntime.type.string], [$traceurRuntime.type.any], [AST], [$traceurRuntime.type.number], [$traceurRuntime.type.string], [SetterFn], [DirectiveRecord]];
  }});
...
Object.defineProperty(BindingRecord.createForHostProperty, "parameters", {get: function() {
    return [[DirectiveIndex], [AST], [$traceurRuntime.type.string]];
  }});
