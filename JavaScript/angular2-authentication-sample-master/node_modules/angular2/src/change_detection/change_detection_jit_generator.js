...
var $__4 = ($__directive_95_record__ = require("./directive_record"), $__directive_95_record__ && $__directive_95_record__.__esModule && $__directive_95_record__ || {default: $__directive_95_record__}),
...
($traceurRuntime.createClass)(ChangeDetectorJITGenerator, {
  ...
  getDirectiveFieldNames: function() {
    ...
    return this.directiveRecords.map((function(d) {
      return $__6.getDirective(d.directiveIndex);
    }));
  },
  getDetectorFieldNames: function() {
    ...
    return this.directiveRecords.filter((function(r) {
      ...
      return $__6.getDetector(d.directiveIndex);
    }));
  },
