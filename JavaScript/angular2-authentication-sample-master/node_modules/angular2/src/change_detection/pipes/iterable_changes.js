...
Object.defineProperties(module.exports, {
  IterableChangesFactory: {get: function() {
      return IterableChangesFactory;
    }},
  IterableChanges: {get: function() {
...
var $__0 = ($__angular2_47_src_47_facade_47_collection__ = require("angular2/src/facade/collection"), $__angular2_47_src_47_facade_47_collection__ && $__angular2_47_src_47_facade_47_collection__.__esModule && $__angular2_47_src_47_facade_47_collection__ || {default: $__angular2_47_src_47_facade_47_collection__}),
    isListLikeIterable = $__0.isListLikeIterable,
    iterateListLike = $__0.iterateListLike,
...
($traceurRuntime.createClass)(IterableChanges, {
  supports: function(obj) {
    return $IterableChanges.supportsObj(obj);
  },
  get collection() {
  ...
  check: function(collection) {
    ...
    if (ListWrapper.isList(collection)) {
      ...
      iterateListLike(collection, (function(item) {
        if (record === null || !looseIdentical(record.item, item)) {
          record = $__3._mismatch(record, item, index);
          mayBeDirty = true;
        } else if (mayBeDirty) {
          record = $__3._verifyReinsertion(record, item, index);
        }
        record = record._next;
        index++;
      }));
...
var $CollectionChangeRecord = CollectionChangeRecord;
