...
Object.defineProperty(ProtoRecord, "parameters", {get: function() {
    return [[$traceurRuntime.type.number], [$traceurRuntime.type.string], [], [List], [List], [$traceurRuntime.type.number], [DirectiveIndex], [$traceurRuntime.type.number], [BindingRecord], [$traceurRuntime.type.string], [$traceurRuntime.type.boolean], [$traceurRuntime.type.boolean]];
  }});
