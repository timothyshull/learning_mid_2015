...
($traceurRuntime.createClass)(Compiler, {
  _bindDirective: function(directiveTypeOrBinding) {
    if (directiveTypeOrBinding instanceof DirectiveBinding) {
      ...
      var meta$__15 = this._reader.read(directiveTypeOrBinding);
      return DirectiveBinding.createFromType(meta$__15.type, meta$__15.annotation);
    }
  },
  compileInHost: function(componentTypeOrBinding) {
    ...
    return this._renderer.createHostProtoView('host').then((function(hostRenderPv) {
      return $__13._compileNestedProtoViews(null, hostRenderPv, [componentBinding], true);
    }));
  },
