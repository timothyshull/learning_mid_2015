            ...
            return {
                                ...
                                instance[name] = (function (name, method) {
                                    return function () {
                                        try {
                                            ...
                                            console.error("Error in module", moduleId, name + ":", e.message); // UISTRING
                                            return null;
                                        }
                                    };
                                }(name, method));
                ...
                stop: function (moduleId) {
                    try {
                        ...
                        console.error("Error stopping the module", moduleId); // UISTRING
                        this.notify({
                ...
                configureView: function (moduleId, viewId, elementRetriever, initializationPriority) {
                    if (_.has(moduleData, moduleId)) {
                        ...
                        if (view) {
                            ...
                            console.error("Can't configure view", viewId, "for module", moduleId + ": view not found"); // UISTRING
                        }
                    } else {
                        console.error("Can't configure view", viewId + ": module", moduleId, "not found"); // UISTRING
                    }
                },
                ...
                removeView: function (moduleId, view) {
                    ...
                    if (view instanceof Object) {
                        ...
                        console.error("Can't destroy the view", view, "of", moduleId, "as it is not a valid view object"); // UISTRING
                    }
                },
