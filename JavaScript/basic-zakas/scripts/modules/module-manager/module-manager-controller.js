...
define(
    ...
    function (core, AppUtility, _) {
        core.register("module-manager", function (sandbox) {
            var managedModules = [ "body"],
                destinationModules = {
                    "body": [ "body" ]
                };
...
//                    sandbox.request({ type: "module-information", success: moduleInformationSuccessHandler, fail: moduleInformationFailHandler });
                },
                ...
                // TODO check that what this module is doing is within its responsibilities
