...
tutorial.Work = module.exports.Work = function(args) {
  this.num1 = 0;
  this.num2 = null;
  this.op = null;
  this.comment = null;
...
tutorial.InvalidOperation = module.exports.InvalidOperation = function(args) {
  Thrift.TException.call(this, "tutorial.InvalidOperation")
  this.name = "tutorial.InvalidOperation"
  this.whatOp = null;
  this.why = null;
  if (args) {
    if (args.whatOp !== undefined) {
